  ...
  var C,
    ...
    O = function (e, t) {
      return function (e, t, n, r$1) {
        ...
        return t.style && g.style !== t.style && (C.style = v({}, t.style, {}, g.style)), C.className = Array.prototype.concat(c, h, S !== h ? S : null, t.className, g.className).filter(Boolean).join(" "), C.ref = b, r.createElement(_, C);
      }(C, e, t, P);
    };
  return O.displayName = y, (C = r__default["default"].forwardRef(O)).attrs = N, C.componentStyle = I, C.displayName = y, C.shouldForwardProp = A, C.foldedComponentIds = o ? Array.prototype.concat(e.foldedComponentIds, e.styledComponentId) : S, C.styledComponentId = g, C.target = o ? e.target : e, C.withComponent = function (e) {
    var r = t.componentId,
      o = function (e, t) {
        if (null == e) return {};
        var n,
...
var StyledAnchor = styled.a.attrs(function (_a) {
  var innerAttributes = _a.innerAttributes;
  return __assign({}, innerAttributes);
})(templateObject_1$3 || (templateObject_1$3 = __makeTemplateObject(["\n    color: ", ";\n    cursor: pointer;\n    ", ";\n"], ["\n    color: ", ";\n    cursor: pointer;\n    ", ";\n"])), function (_a) {
  var color = _a.color;
  return color;
}, function (_a) {
  var innerStyles = _a.innerStyles;
  return innerStyles;
});
/**
...
var Anchor = function (_a) {
  var _b = _a.color,
    color = _b === void 0 ? '#4665AE' : _b,
    _c = _a.innerAttributes,
    innerAttributes = _c === void 0 ? {} : _c,
    _d = _a.innerStyles,
    innerStyles = _d === void 0 ? {} : _d,
    _e = _a.children,
    children = _e === void 0 ? null : _e;
  return /*#__PURE__*/r__default["default"].createElement(StyledAnchor, {
    color: color,
...
var Button = function (_a) {
  var _b = _a.background,
    background = _b === void 0 ? '#000000' : _b,
    _c = _a.color,
    color = _c === void 0 ? '#FFFFFF' : _c,
    _d = _a.innerAttributes,
    innerAttributes = _d === void 0 ? {} : _d,
    _e = _a.innerStyles,
    innerStyles = _e === void 0 ? {} : _e,
    _f = _a.children,
    children = _f === void 0 ? null : _f;
  return /*#__PURE__*/r__default["default"].createElement(StyledButton, {
...
var StyledCard = styled.div.attrs(function (_a) {
  var innerAttributes = _a.innerAttributes;
  return __assign({}, innerAttributes);
...
var Card = function (_a) {
  var _b = _a.background,
    ...
    _e = _a.innerStyles,
    innerStyles = _e === void 0 ? {} : _e;
  return /*#__PURE__*/r__default["default"].createElement(StyledCard, {
    background: background,
    innerAttributes: innerAttributes,
    innerStyles: innerStyles
  }, children);
...
var Variant;
(function (Variant) {
  Variant[Variant["p"] = 0] = "p";
  Variant[Variant["h1"] = 1] = "h1";
  Variant[Variant["h2"] = 2] = "h2";
  Variant[Variant["h3"] = 3] = "h3";
  Variant[Variant["h4"] = 4] = "h4";
  Variant[Variant["h5"] = 5] = "h5";
  Variant[Variant["h6"] = 6] = "h6";
})(Variant || (Variant = {}));
var Variant$1 = Variant;

var _a;
var styles = (_a = {}, _a[Variant$1.p] = {
  fontSize: '1rem',
  fontWeight: 'normal'
}, _a[Variant$1.h1] = {
  fontSize: '2.5rem',
...
var getTypographyStyles = function (variant) {
  return styles === null || styles === void 0 ? void 0 : styles[variant];
};

var StyledTypography = styled.p.attrs(function (_a) {
  var innerAttributes = _a.innerAttributes;
  return __assign({}, innerAttributes);
  ...
  return getTypographyStyles(variant !== null && variant !== void 0 ? variant : Variant$1.p);
}, function (_a) {
  var innerStyles = _a.innerStyles;
  return innerStyles;
});
...
var Typography = function (_a) {
  var _b = _a.variant,
    variant = _b === void 0 ? Variant$1.p : _b,
    _c = _a.color,
    color = _c === void 0 ? '#FFFFFF' : _c,
    _d = _a.innerAttributes,
    innerAttributes = _d === void 0 ? {} : _d,
    ...
    _f = _a.children,
    children = _f === void 0 ? null : _f;
  return /*#__PURE__*/r__default["default"].createElement(StyledTypography, {
    variant: variant,
    color: color,
    innerAttributes: innerAttributes,
    innerStyles: innerStyles
